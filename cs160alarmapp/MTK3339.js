	...
	sources: [
		{
			...
			result: 
				{ type: "Object", name: "result", properties:
					[
						{ type: "Number", name: "latitude", defaultValue:37.869107, min: 37.86, max: 37.88, decimalPlaces: 6 },
						{ type: "Number", name: "longitude", defaultValue:-122.259716, min: -122.27, max: -122.25, decimalPlaces: 6 },
					]
				},
		},
	]
